...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="row">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <div class="">
                <h1 class="h2">لوحة التحكم الخاصة في قسم (من نحن)</h1>
            </div>
        </div>
        <div class="">
            <?php
            if (isset($_POST['submit']) && !empty($_POST['title']) && !empty($_POST['description'])) {
                ...
                if (empty($description)) {
                    ...
                    if (file_exists($_FILES['image']['tmp_name'])) {
                        ...
                        include 'config.php';
                        $sql = "INSERT INTO `about_us`(`title`, `description` , `image`) VALUES ('$title','$description','$imageName')";
            ...
            if (isset($_GET['id'])) {
                include "config.php";
                $sql2 = "SELECT * FROM `about_us` where id= " . $_GET['id'];
                ...
                if (isset($_POST['edit'])) {
                    ...
                    if (file_exists($_FILES['image']['tmp_name'])) {
                        ...
                        $imageName = "img" . time() . "." . $ext;
                        move_uploaded_file($_FILES['image']['tmp_name'], '../images/' . $imageName);
                        $sql = "UPDATE `about_us` SET `title`='$title',`description`='$description' , `image` = '$imageName' WHERE id = " . $data['id'];
                        $result = mysqli_query($config, $sql);
                        if (!$result) {
                            $error =
                                '
                        ...
                        $sql = "UPDATE `about_us` SET `title`='$title',`description`='$description'  WHERE id = " . $data['id'];
                        $result = mysqli_query($config, $sql);
                        if (!$result) {
                            $error =
                                '
            ...
            <form method="POST" class="mb-3 border-bottom" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <a href="about.php" class="btn btn-secondary m-2" style="width: 100px;">الغاء</a>
                </div>
            </form>
        </div>
        <div class="">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="about.php?id=' . $row['id'] . '"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                                <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                                              </svg> تعديل</a></li>
                                                <li><a class="dropdown-item text-danger" href="delabout.php?id=' . $row['id'] . '"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
